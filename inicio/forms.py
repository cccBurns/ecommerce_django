...
class ChangePasswordForm(SetPasswordForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['new_password1'].help_text = '<ul class="form-text text-muted small"><li></li><li>Su contraseña debe contener al menos 8 caracteres.</li><li></li><li>Su contraseña no puede ser completamente numérica.</li></ul>'
